...
Route::prefix('knowledgebase')->name('knowledgebase.')->group(function () {
    ...
    Route::get('list', 'knowledgebaseController@index')->name('index');
    //Route::get('add', 'knowledgebaseController@add')->name('add');
    // Route::get('contact', 'ContactController@index')->name('contact');
});
...
Route::post('user/submit','UserController@submit1');
